  ...
  <?php 
    if (isset($_POST['register'])) {
      ...
      if($db->std_entry($conn,$studentName,$dob,$gender,$email,$phone,$add,$session,$semester)){
             ...
             <div class="row">
                    <div class="templatemo-line-header" style="margin-top: 0px;" >
                        <div class="text-center">
                            <hr class="team_hr team_hr_left hr_gray"/><span class="span_blog txt_darkgrey txt_orange"> Entry</span>
        ...
        <div class="row">
         <div class="col-lg-4">
          ...
          <div class="form-group">
            ...
            <input type="textarea" class="form-control" id="add" placeholder="Your address please" rows="3" name="add"></input> 
          </div>
          </div>
          </div>
          </div>

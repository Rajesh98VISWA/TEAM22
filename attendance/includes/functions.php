...
//Students Entry
/*********************/
 function std_entry($conn,$studentName,$dob,$gender,$email,$phone,$add,$session,$semester){
	try{
		
		$query = "INSERT INTO student_table SET student_name = ?, dob = ?, gender = ?,email = ?,phone = ?, address = ?, Session=?,Semester=?";
